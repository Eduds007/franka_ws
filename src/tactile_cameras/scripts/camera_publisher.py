#!/usr/bin/env python3
"""
GelSight Camera Publisher Node
Publishes camera feeds from GelSight tactile sensors (USB cameras) to ROS2 topics
"""
...
class CameraPublisherNode(Node):
    ...
    def __init__(self):
        super().__init__('gelsight_camera_publisher')
        ...
        self.get_logger().info("📸 GelSight Camera Publisher Node initialized")
    
    def setup_cameras(self):
        """Setup cameras"""
        self.get_logger().info("🔧 Setting up GelSight cameras...")
...
def main():
    ...
    try:
        ...
        print("\n" + "="*60)
        print("📸 GelSight Camera Publisher Node")
        print("="*60)
